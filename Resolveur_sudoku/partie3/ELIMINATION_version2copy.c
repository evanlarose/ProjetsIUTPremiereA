...
* @file sudoku.c
*
* @brief programme resolution de grille de sudoku
*
* @author Evan Larose
*
*/
...
// bool possibleSingletonLig(tGrille g, int ligne, int val);
// bool possibleSingletonCol(tGrille g, int col, int val);
...
int main()
{
    ...
    while (nbCasesVides != 0 && progression)
    {
        ...
        //             {
        //                 if(estCandidat(g[l][c], i) && (possibleSingletonLig(g, l, i) || possibleSingletonCol(g, c, i) || possibleSingletonBloc(g, l, c, i)))
        //                 {
        //                     affecterSingletonCache(&g[l][c], i);
        //                     nbCasesVides = nbCasesVides - 1;
        //                     retirerCandidatsLigColBloc(g, l, c, g[l][c].valeur);
        //                     progression = true;
        //                 }
...
// {
//     /*verification de la ligne de la case(c parcours la colonne)*/
//     for (int c = 0; c<val && c>val && c<TAILLE; c++)
//     {
...
// {
//     /*verification de la colonne de la case(l parcours la ligne)*/
//     for(int l = 0; l<val && l>val && l<TAILLE; l++)
//     {
